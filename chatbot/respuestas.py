...
🔹 ¿ES OBLIGATORIO?
Sí. Para cualquier proceso de contratación con UNIMINUTO, el RUT es un documento obligatorio e indispensable.
...
¿Es persona natural o empresa? Dígame y le doy la lista exacta."""
    ...
    # ==================== PORTAL ====================
    "portal_proveedores": [
        """🌐 REGISTRO EN EL PORTAL DE PROVEEDORES - GUÍA COMPLETA
